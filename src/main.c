...
"\n"
"DESCRIPTION\n"
"   Server for remote control Linux systems, that uses libx11 for interact with the X server.\n"
"   Allows mouse movement, unicode keys writing, hotkeys.\n"
"   Supports a discovery mechanism too.\n"
"\n"
"COMMANDS\n"
"   -h \n"
